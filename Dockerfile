...
RUN apt-get update &&\
    ...
    apt-get update &&\
    apt-get install -y python-pip handbrake-cli libssl1.0.0 libexpat1 libavutil55 libavformat57 libavcodec-dev libavcodec57 libavcodec-extra57 libgl1-mesa-glx unzip &&\
